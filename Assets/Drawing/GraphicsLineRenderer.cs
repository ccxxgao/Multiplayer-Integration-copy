...
public class GraphicsLineRenderer : MonoBehaviour {
	...
	public void InitializeVertices(int length) {
		ml.vertices = new Vector3[1];
	}
	...
	public void AddPoint(Vector3 point) {
		// if (ml != null) {
		// 	Debug.Log("Point: " + point.ToString() + ", VERTICES IS NOT NULL: " + ml.vertices.Length.ToString());
		// } else {
		// 	ml = GetComponent<MeshFilter>().mesh;
		// 	Debug.Log("Point: " + point.ToString() + "VERTICES ARE NULL FOR SOME REASON");
		// }
